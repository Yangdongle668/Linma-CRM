 ...
 */
@Data
@Schema(description = "询盘更新DTO")
public class InquiryUpdateDTO implements Serializable {
     ...
     * 状态
     */
    @Schema(description = "状态(new/processing/quoted/converted/closed)", example = "processing")
